...
select order_id,order_date,total_amount,name,email
from orders
left join customers
on orders.customer_id=customers.customer_id;
select customers.customer_id,name,phone,order_id,status
from customers
left join orders
on customers.customer_id=orders.customer_id;
select customers.customer_id,name,order_id,total_amount,order_date
from customers
inner join orders
on customers.customer_id=orders.customer_id;
