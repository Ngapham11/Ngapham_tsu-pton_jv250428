    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <a class="btn btn-danger" href="<%=request.getContextPath()%>/project?action=delete&id=${project.id}" onclick="return confirm('Bạn có chắc chắn muốn xóa thông tin này không?')" >Xoa</a>
            </td>
        </tr>
        </c:forEach>
        </tbody>
